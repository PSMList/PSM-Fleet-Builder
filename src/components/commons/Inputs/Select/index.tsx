...
const Select = (props: SelectProps) => {
    ...
    const [selectedOption, setSelectedOption] = createSignal<Option>({ value: props.defaultSelectText || '', display: props.defaultSelectText });
    ...
    onMount(() => {
        ...
        if (props.defaultSelectOption) {
            ...
            if (defaultOption) {
                setSelectedOption(() => ({ value: defaultOption.value, display: (defaultOption.display as Node).cloneNode(true) }));
    ...
    const handleOptionClick = (event: Event) => {
        ...
        batch(() => {
            ...
            if (!option) return;
            setSelectedOption(() => ({ value: option.value, display: (option.display as Node).cloneNode(true) }));
            setShowOptionList(() => false);
        });
    }
    ...
    return (
        ...
        >
            <select class={ props.class } style="display: none" ref={ (ref) => { selectRef = ref; } }>
                {
